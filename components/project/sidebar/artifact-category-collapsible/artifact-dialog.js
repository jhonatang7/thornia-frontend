...
import { ArtifactContext } from "@/components/project/sidebar/artifact-category-collapsible/artifact-collapsible";
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ¿Esta seguro que desea eliminar el artefacto '{title}' de tipo{" "}
            {type}?
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
